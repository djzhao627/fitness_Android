...
import com.lilei.fitness.adapter.OrdersListAdapter;
...
public class OrdersListActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener {

    private String TITLE_NAME = "我的订单";
    ...
    private void getComments() {
        ...
        String url = Constants.BASE_URL + "Order?method=queryOrders";
        OkHttpUtils
                .post()
                .url(url)
                .id(1)
        ...
        public void onResponse(String response, int id) {
            ...
            switch (id) {
                case 1:
                    ...
                    Type type = new TypeToken<ArrayList<UserOrderVO>>() {
                    }.getType();
                    ...
                    if (mList == null || mList.size() == 0) {
                        ...
                        // 存储用户
                        adapter = new OrdersListAdapter(mContext, mList);
